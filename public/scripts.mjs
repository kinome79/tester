...
//const myfont = new FontFace('Press Start 2P', 'url(https://fonts.gstatic.com/s/pressstart2p/v14/e3t4euO8T-267oIAQAu6jDQyK3nRivN04w.woff2)');
...
function drawTitle() {
context.font = "16px 'Press Start 2P'"; context.fillText("hello", 50,50);
